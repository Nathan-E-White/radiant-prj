...
- `GET /api/simulator-workbench/snapshot` is the sole public Workbench read: one coherent, generation-bound, non-mutating Snapshot containing State, Measured State, Simulated Result State, Twin State, and Lineage. Internal projection queries do not expose browser routes.
