...
const requiredFiles = [
  ...
  "scripts/check-artifact-forge.mjs",
...
if (existsSync("deploy/slurm-gateway.Dockerfile")) {
  ...
  for (const token of [
    ...
    "go test -p 2 -tags dataplane,iceberggo ./...",
    "go build -p 2 -tags dataplane -trimpath -ldflags=\"-s -w\" -o /out/slurm-gateway ./cmd/server",
    "go build -p 2 -tags dataplane -trimpath -ldflags=\"-s -w\" -o /out/simops-stream-gateway ./cmd/simops-stream-gateway",
    "-tags dataplane",
    ...
    "simops-stream-gateway-runtime",
    "simops-timescale-writer-runtime",
    "simops-iceberg-writer-runtime",
    "workbench-projection-writer-runtime",
    "twin-projector-runtime",
    "workbench-iceberg-writer-runtime",
    "docker-cli",
    "USER appuser",
