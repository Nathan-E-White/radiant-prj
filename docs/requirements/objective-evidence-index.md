...
| SIMOPS-TOFU-SUBSTRATE-001 | Issue #26 OpenTofu local Kubernetes substrate lane | SW-022 | `infra/opentofu/simops-kind-substrate/`, `scripts/simops-opentofu-preflight.sh`, `scripts/check-simops-opentofu-substrate.mjs`, `docs/design/issue-26-opentofu-simops-substrate.md` | Static substrate only; no per-run Job apply, production cloud provisioning, operator, or data-plane credential distribution |
