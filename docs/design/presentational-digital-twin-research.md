...
- Leave the existing SimOps Control surface separate for this slice. The Simulator Workbench may reference fixture-backed Simulated Result State, but it shall not absorb run controls or backend/control-plane monitoring.
