...
| Repository verification | `config/repository-verification.json`, `scripts/repository-verification/` | Verifies architecture and delivery claims from structured, executable, and contractual document evidence |
...
| Recoverable delivery, Run, and review truth | `docs/design/recoverable-delivery-run-review-truth.md`, `docs/design/master-architecture-findings-primary-source-research.md`, `docs/design/iceberg-delivery-assurance-recovery-research.md` | Governs Issue #202 delivery, publication, Run, stream, telemetry, and review invariants without claiming cross-store exactly-once processing |
